    ...
    <div className="min-h-screen bg-background flex items-center justify-center">
      <div className="card max-w-sm w-full mx-4 p-8">
        ...
        <div className="relative my-6">
          ...
          <div className="relative flex justify-center text-xs"><span className="px-2 bg-card text-slate-500">{t("or")}</span></div>
        </div>
        ...
        >
          ...
          {t("continueWithGoogle").replace("Google", "GitHub")}
        </button>

        <p className="text-center text-xs text-slate-500 mt-6">
          {t("noAccount")}{" "}
          <Link href="/register" className="text-primary hover:underline">{t("signUpButton")}</Link>
        </p>
      </div>
    </div>
  );
