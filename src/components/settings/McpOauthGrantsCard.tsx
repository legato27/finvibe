                  ...
                  <div className="flex items-center gap-2">
                    ...
                    <span
                      className={`text-[9px] px-1.5 py-0.5 rounded font-mono uppercase tracking-wider ${
                        g.status === "active"
                          ? "bg-signal-long/15 text-signal-long border border-signal-long/30"
                ...
                <div className="flex items-center gap-1 flex-shrink-0">
                  {g.status === "active" && (
                    <button
                      ...
                      className="px-2 py-1 text-[11px] rounded border border-border text-muted-foreground hover:text-signal-caution hover:border-signal-caution/40 disabled:opacity-50"
                    >
                      {t("grants.signOut")}
                    </button>
                  )}
                  {g.owned_by_me && (
                    <button
                      ...
                      className="p-1.5 text-muted-foreground hover:text-signal-short disabled:opacity-50"
                    >
                      {busyId === g.client_id ? (
